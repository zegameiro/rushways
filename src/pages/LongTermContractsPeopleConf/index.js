...
import vehiclesLT from "../LongTermContractsPeople/vehicles";
...
const OcasionalServicesConf = () => {
    ...
    const getTotalPrice = () => {
        ...
        for (const vehicleId in selectedVehiclesQuantities) {
            ...
            total += vehiclesLT[vehicleId - 1].priceOneDay * selectedVehiclesQuantities[vehicleId];
        }
        return total;
    }
            ...
            <div className="confirmation-page" style={{paddingLeft:"50px"}}>
                ...
                <div>
                    {Object.keys(selectedVehiclesQuantities).map((vehicleId) => {
                        const vehicle = vehiclesLT[vehicleId - 1];
                        const showDriverOption = vehicle.isDriver;
                        return (
                            <>
                                <Row>
                                    <Col sm={6}>
                                        <img src={vehiclesLT[vehicleId - 1].image} alt={vehiclesLT[vehicleId - 1].vehicleName} />
                                    </Col>
